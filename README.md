...
# 整理建站规划
俗话说**磨刀不误砍柴工**，俗话又说**方向不对，走的越快错的越远**，可见俗话是多么的富有哲理。当然，我想说的是在网站制作前您要有一个认真的规划，工作有目标我们才能让建站工作更高效，也更易达成。做好一个网站的规划，你也许要考虑以下几个方面：
1. 我的客户群体是谁
2. 我的网站要展示什么内容
2. 我的网站要设立那些栏目
3. 我有没有准备好相应的文字内容
...
6. 我要不要设立多语言内容展示
7. 我心目中的网站大概什么样子
8. 是否有做好部分费用预算（什么预算？Joomla不是免费吗！的确，Joomla是开源免费的系统。但是网站建设你还要考虑是否需要服务器租用等其他问题。）
9. 我将网站存放在哪里（国内有华为云、阿里云、腾讯云等服务器可以存放你的网站，但需要备案后使用，当然您可以在网站制作期间使用临时域名或IP地址进行在线访问。具体可咨询你的服务器提供商）
...
开始之前我们要获取Joomla! CMS。有多个方法可以获取到Joomla CMS开始你的建站工作。

方法一、你可以通过Joomla.org网站下载最新的Joomla CMS程序。
打开https://downloads.joomla.org/zh-cn/，进行安装包下载。通过这个方法获取的是的是标准Joomla程序（是英文版，需要在安装Joomla后进行汉化包安装）。

获取Joomla

 

方法二、通过购买Joomla商业模板，来获取Joomla。
有很多Joomla模板生产团队会围绕Joomla定制很多精彩的模板样式，您可以通过这些模板服务团队的网站购买模板，并同时获得一套带模板的Joomla整站数据。我们推荐你通过这种方式开展Joomla的安装及学习。因为这些预装了模板的Joomla整站提供了大量的示范效果，可以让你很容易的进行网站搭建。比如模板森林中会有很多优秀Joomla模板可以购买，一般费用在300元人民币左右 https://themeforest.net/category/cms-themes/joomla

获取Joomla

方法三、通过其他渠道获取Joomla商业模板，来获取Joomla。
...
Joomla标准安装包是一个17MB左右的压缩文件。如果在方法二、三下载的带商业模板的安装包，由于集成了商业模板中的图片及数据，安装包会增大不少，一般会有30MB以上，稍后的章节我们介绍如何安装Joomla!
