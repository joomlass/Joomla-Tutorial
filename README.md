...
无论您是Joomla初学者或是资深用户，通过本教程学习相信都能让你有不少收获。尤其是对Joomla感兴趣的初级用户，本教程一定能够很好的让你成为Joomla专业用户，成功搭建自己的网站并做好日常管理。
## 课程设立：
1. [Joomla介绍](./Joomle介绍)
2. [整理建站规划](./整理建站规划)
3. [获取Joomla](./获取Joomla)
...
Joomla是一套开源的内容管理系统（简称CMS）。我们可以理解为它是一套免费、好用的建站系统。它本身就是一套网站，在你安装后你就立刻拥有了一套完整的网站。当然，全球有很多开源内容管理系统，比如和Joomla一样知名的Drupal和WordPress系统。但Joomla是有它独有的优势及特点，后面我们会重点提及。并且它是唯一连续5年被评为最好的“开源内容管理系统”，可见它的优势并非浪得虚名。从使用角度来讲，稳定性和灵活的功能扩充是Joomla被从业者公认的优秀特性。
...
## Joomla应用领域：
作为内容管理系统，Joomla当然的核心优势就在于各种类型的内容发布管理，包括文字、图片、音频视频、文件等。 Joomla的长处是将内容灵活的调取管理。没错Joomla非常适合做网站，无论是企业、政府、教育、金融、多语言网站等各行业的官网制作都不在话下，使用Joomla模板我们可以在1个小时内搭建出自己的网站。实现电商网站？只需要安装电商组件，Joomla即可变身电商平台分类出售您的商品。类似58网的分类信息、黄页广告等也很适合用Joomla实现。很多企业会选则Joomla与其内部OA系统、ERP系统进行关联进行内容管理。Joomla还可以用于创建社区论坛及博客网站。Joomla在专业IT人员中的口碑很好，一直以来它被认为是“IT从业者推荐的建站系统”。
...
# Joomla的学习方法
本教程作者自从Joomla1.5开始接触其使用，为诸多企业用Joomla完成了信息化解决方案的提供与实施，有丰富的Joomla项目实施经验，并且我们为每个项目客户的Joomla使用进行培训，无论受训者是IT人员还是对网站制作一窍不通的办公室文员，他们都很好的掌握了Joomla的使用管理。因此，请放心，此教程一定能够让你熟悉Joomla并能够上手搭建你的网站系统。
